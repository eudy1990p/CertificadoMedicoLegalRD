...
public class AdminTheme extends javax.swing.JFrame {
    ...
    String pathImagen2 = "";
    String pathImagen3 = "";
    private String headBody ="<html><head></head><body><p>";
    private String footerBody ="</p></body></html>";
    ...
    public boolean validarVacios(){
        ...
        if(esvacio(this.jTextField7,"Genero")){
            return true;
        }
    ...
    private void initComponents() {
        ...
        setTitle("Certificado Medico Legal RD");

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Click para agregar imagen1");
        ...
        jTextField4.setText("CQ25419-301");

        jTextField5.setText("04/07/2015");
        ...
        jTextField8.setText("OTROS No.: MENOR");
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
       ...
       if(willClick){
            waitForUpdate startChooser = new waitForUpdate(this.thisClass);
            startChooser.start();
            willClick = false;
       }
    ...
    public void emtpyAll(){
        ...
        this.jTextField4.setText("");this.jTextField5.setText("");this.jTextField6.setText("");
        this.jTextField7.setText("");this.jTextField8.setText("");this.jTextField9.setText("");
